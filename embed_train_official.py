...
CATALOG_PATH = ROOT / "train_official.parquet"
OUTPUT_PATH = ROOT / "train_embeddings.parquet"
FAIL_LOG_PATH = ROOT / "embed_failures.txt"


def main() -> None:
    if not CATALOG_PATH.exists():
        raise FileNotFoundError(f"Missing {CATALOG_PATH}. Run export_train_official.py first.")
