...
Cohesion: 0.09
Nodes (37): datetime, json, platform, socket, build_samples(), canonical_name(), classification_metrics(), inventory_name_from_filename() (+29 more)
...
Cohesion: 0.09
Nodes (41): choose_folder(), import_train_catalog(), inventory_name_from_filename(), masked_crops(), _polygon_rows(), Image, ndarray, Path (+33 more)
...
Cohesion: 0.19
Nodes (14): matplotlib_patches, crop_labeled_objects(), Image, Crop each labeled object from ``image`` and attach bbox metadata., _color_for_name(), draw_predictions(), predict_labeled_image(), DataFrame (+6 more)

### Community 44 - "ensure_tables"
Cohesion: 0.33
...
### Community 49 - "db.py"
Cohesion: 0.12
Nodes (24): Compatibility wrappers. All SQL lives in sql.py., check_db(), clear_check_in_out(), close_boot_connection(), compare_mobileclip2_vs_noise(), _embedding_to_text(), insert_check_in_out(), insert_staff() (+16 more)

### Community 50 - "visualize_results.py"
Cohesion: 0.23
Nodes (18): csv, matplotlib, matplotlib_pyplot, build_confusion(), canonical(), confusion_matrix(), draw_confusion(), label_bars() (+10 more)
