...
### Community 3 - "main.py"
Cohesion: 0.09
Nodes (31): asyncio, delete, fastapi_middleware_cors, fastapi_responses, boot_status(), camera_status(), catalog_import_active(), catalog_import_status() (+23 more)
...
### Community 15 - "run_high_end_boot"
Cohesion: 0.22
Nodes (11): get_lan_ip(), load_face_gate(), load_model(), run_high_end_boot(), set_boot(), startup_event(), create_mask(), create_session() (+3 more)
...
### Community 21 - "post"
Cohesion: 0.11
Nodes (26): BaseModel, analyze_face_frame(), api_start_camera(), capture_sam_frame(), detection_preview_active(), embed_captured_face(), face_status_payload(), FaceModeBody (+18 more)

### Community 22 - "load_embed_model"
Cohesion: 0.16
...
### Community 36 - "_encode_worker_loop"
Cohesion: 0.22
Nodes (11): _apply_face_embedding(), _encode_image(), _encode_images(), _encode_worker_loop(), face_crop_to_embedding(), _face_detect_job(), _face_embed_worker(), handle_face_info() (+3 more)
